...
const initialData = [
	{ formato: 'Club', ventaPzas: 131846 },
	{ formato: 'Express', ventaPzas: 6222 },
	{ formato: 'Frescura', ventaPzas: 3554 },
	{ formato: 'GBS', ventaPzas: 46836 },
	{ formato: 'Mostrador', ventaPzas: 361046 },
	{ formato: 'Reparto', ventaPzas: 845241 },
];

export function VentasPorFormatoChartFebrero() {
		...
		<div className="h-full p-6 bg-white rounded-lg border shadow-sm">
			...
			<div className="mb-4">
				<div className="flex justify-between items-start">
					<div>
						<h3 className="text-lg font-semibold">Ventas por Formato</h3>
